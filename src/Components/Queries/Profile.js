...
const Profile = () => {
  ...
  return (
    <main className="flex w-full flex-col justify-center md:w-fit">
      {profile.name ? (
        <>
          <div className=" my-4 flex w-full justify-center overflow-auto dark:border-slate-500 dark:p-[1px] hover:text-violet-500 hover:animate hover:duration-200 ">
            {user.userType === "staff" ? (
              <PiUserThin className="m-2 rounded-full border-2 border-slate-900 p-1 text-6xl dark:border-slate-300 md:p-2 md:text-9xl lg:text-[12rem] hover:border-violet-500 " />
            ) : (
            ...
            <div className="flex flex-col items-start justify-center ">
              <h2 className=" whitespace-break-spaces text-3xl font-bold  underline decoration-inherit decoration-2 underline-offset-4 dark:mt-0  md:text-6xl ">
                {user?.name}
              </h2>
