    ...
    <main className="internal">
      ...
      <section className="internal__body">
        <form className="internal__body__form group">
          ...
          <p className="text-balance m-2 overflow-hidden text-ellipsis whitespace-break-spaces rounded bg-red-300/50 p-1 text-center font-medium text-red-700 dark:bg-transparent group-invalid:block hidden">
            invalid Data
          </p>
        </form>
      </section>
